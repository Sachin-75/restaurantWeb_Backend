...
const addCartItems = async (req, res) => {
    ...
    console.log("request body==>",menuItemId, name, quantity, image, price)
...
const deleteCartItems = async (req, res) => {
    ...
    try {
        ...
        // await cartModel.findByIdAndDelete(menuItemId, function(error, docs){
        //     if(error){
        //         return res.status(404).json({ error: "Cart item not found or already deleted." });
        //     }
        // })
...
const getCartItems = async (req, res) => {
    ...
    try {
      ...
      console.log("Cart items fetched for user:", updatedCartItems);
